...
class LocationFinder
  def self.call(address, ip_address)
    if !address.empty?
      ...
      unless loc["error"]
        { latitude: loc["latt"].to_f, longitude: loc["longt"].to_f, city: loc["standard"]["city"], timezone: loc["timezone"] }
      end
      ...
      unless loc["error"]
        { latitude: loc["latitude"], longitude: loc["longitude"], city: loc["city"], timezone: loc["timezone"] }
      end
    end
  end
end
